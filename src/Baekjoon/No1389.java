...
// 친구 관계는 중복되어 들어올 수도 있으며, 친구가 한 명도 없는 사람은 없다. 또, 모든 사람은 친구 관계로 연결되어져 있다. 사람의 번호는 1부터 N까지이며,
...
public class No1389 {
    public static void main(String[] args) {
        ...
        // 플로이드 와샬 알고리즘
        // k는 중간의 거쳐가는 값 - 플로이드 와샬 알고리즘의 핵심 아이디어는 이 중간 거쳐가는 값 K에 초점을 맞추었다는 것이다.
        for (int k = 1; k <= n; k++) {
            for (int i = 1; i <= n; i++) {
                for (int j = 1; j <= n; j++) {
                    // 최단 경로 초기화
